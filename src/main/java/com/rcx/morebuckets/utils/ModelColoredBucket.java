...
public final class ModelColoredBucket implements IModel, IModelCustomData, IRetexturableModel
{
    ...
    public static final IModel MODEL = new ModelColoredBucket();
    ...
    public ModelColoredBucket()
    {
        this(null, null, null, null, false);
    }

    public ModelColoredBucket(ResourceLocation baseLocation, ResourceLocation liquidLocation, ResourceLocation coverLocation, Fluid fluid, boolean flipGas)
    {
        this.layer0 = baseLocation;
        this.layer1 = liquidLocation;
        this.layer2 = coverLocation;
        this.fluid = fluid;
                                    ...
                                    Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
    {
        ...
        {
            // build base (insidest)
            IBakedModel model = (new ItemLayerModel(ImmutableList.of(layer0))).bake(state, format, bakedTextureGetter);
            builder.addAll(model.getQuads(null, null, 0));
        }
        if (layer1 != null && fluidSprite != null)
        {
            TextureAtlasSprite liquid = bakedTextureGetter.apply(layer1);
        ...
        if (layer2 != null)
        {
            ...
            TextureAtlasSprite base = bakedTextureGetter.apply(layer2);
     ...
     */
    @Override
    public ModelColoredBucket process(ImmutableMap<String, String> customData)
    {
        ...
        return new ModelColoredBucket(layer0, layer1, layer2, fluid, flip);
    }
     ...
     */
    @Override
    public ModelColoredBucket retexture(ImmutableMap<String, String> textures)
    {

        ResourceLocation base = layer0;
        ResourceLocation liquid = layer1;
        ResourceLocation cover = layer2;

        if (textures.containsKey("layer0"))
            base = new ResourceLocation(textures.get("layer0"));
        if (textures.containsKey("layer1"))
            liquid = new ResourceLocation(textures.get("layer1"));
        if (textures.containsKey("layer2"))
            cover = new ResourceLocation(textures.get("layer2"));

        return new ModelColoredBucket(base, liquid, cover, fluid, flipGas);
    }
    ...
    public enum LoaderDynBucket implements ICustomModelLoader
    {
        ...
        {
            return modelLocation.getResourceDomain().equals("morebuckets") && modelLocation.getResourcePath().contains("colorized_bucket");
        }
    ...
    private static final class BakedDynBucket implements IPerspectiveAwareModel
    {
        ...
        private final ModelColoredBucket parent;
        // FIXME: guava cache?
        ...
        public BakedDynBucket(ModelColoredBucket parent,
